        ...
        <div class="content-area">
          ...
          <div id="dashboard-section" class="section active">
            ...
            <div class="cards-row">
              ...
              <div class="card"><h3>Próximas Citas</h3><p class="empty-msg">No hay citas programadas</p></div>
            </div>
          </div>
          ...
          <!-- ===== OTHER SECTIONS ===== -->
          <div id="clients-section" class="section"><div class="card"><h3>Gestión de Clientes</h3><p class="empty-msg">Módulo en desarrollo</p></div></div>
