...
'Manage who can access al CRM y qué secciones puede ver.':'Manage who can access the CRM and what sections they can see.',
'Manage who can access the CRM y qué secciones puede ver.':'Manage who can access the CRM and what sections they can see.',
'Solo el':'Only the',
'puede administrar usuarios.':'can manage users.',
'Acceso total. My Money, cuenta bancaria, configuración, usuarios.':'Full access. My Money, bank account, settings, users.',
'configuración, usuarios.':'settings, users.',
...
var PATTERNS = [
  ...
  [/al CRM y qué secciones puede ver/g, 'the CRM and what sections they can see'],
  [/y qué secciones puede ver/g, 'and what sections they can see'],
  [/Solo el/g, 'Only the'],
  [/puede administrar usuarios/g, 'can manage users'],
  [/cuenta bancaria/g, 'bank account'],
  [/configuración, usuarios/g, 'settings, users'],
  ...
  [/miércoles, (\d+) de (\w+)/g, function(m,d,mo){return 'Wednesday, '+mo+' '+d}],
  [/jueves, (\d+) de (\w+)/g, function(m,d,mo){return 'Thursday, '+mo+' '+d}],
  [/viernes, (\d+) de (\w+)/g, function(m,d,mo){return 'Friday, '+mo+' '+d}],
  [/sábado, (\d+) de (\w+)/g, function(m,d,mo){return 'Saturday, '+mo+' '+d}],
...
function init(){
  ...
  console.log('✅ i18n-patch.js v7 loaded — ' + Object.keys(T).length + ' translations + ' + PATTERNS.length + ' patterns ready');
